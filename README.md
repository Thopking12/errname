...
[![CI](https://github.com/wideeyedseri/errname/actions/workflows/ci.yml/badge.svg)](https://github.com/wideeyedseri/errname/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/wideeyedseri/errname)](https://goreportcard.com/report/github.com/wideeyedseri/errname)
...
```
$ go install github.com/wideeyedseri/errname@latest
$ errname ./...
```
...
More examples in [tests](https://github.com/wideeyedseri/errname/blob/master/pkg/analyzer/facts_test.go).
